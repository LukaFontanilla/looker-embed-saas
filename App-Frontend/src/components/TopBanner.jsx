...
const TopBanner = () => {
    ...
    return (
        ...
        <nav className="flex items-center justify-between px-6 py-4 border-b border-zinc-200 dark:border-zinc-800 z-10" >
            ...
            <svg version="1.1" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 24 24" overflow="visible">
            <g transform="scale(0.889,0.889)">
                <path fill="#D2E3FC" d="M7.4,1.5c-1.2,0-2.1,0.9-2.1,2.1c0,0.4,0.1,0.8,0.4,1.2l0.9-0.9c0-0.1,0-0.2,0-0.3c0-0.5,0.4-0.9,0.9-0.9
                ...
                <path fill="#5E97F6" d="M6.6,7.6c0-0.7-0.2-1.4-0.6-2L4.8,6.8C4.9,7.1,5,7.3,5,7.6c0,0.5-0.2,0.9-0.5,1.2l0.6,1.6
                    C6.1,9.8,6.6,8.7,6.6,7.6z"/>
                <path fill="#5E97F6" d="M3.4,9.3L3.4,9.3c-0.9,0-1.7-0.7-1.7-1.6c0-0.9,0.7-1.7,1.6-1.7c0.3,0,0.7,0.1,1,0.3l1.2-1.1
                    C4.8,4.6,4.1,4.3,3.3,4.3C1.5,4.3,0,5.8,0,7.6c0,1.8,1.4,3.3,3.3,3.3c0.2,0,0.5,0,0.7-0.1L3.4,9.3z"/>
                <path fill="#4285F4" d="M7.5,10.6c-0.7,0-1.4,0.1-2.1,0.3l0.9,2.2C6.7,13.1,7.1,13,7.5,13c2.8,0,5,2.3,5,5c0,2.8-2.3,5-5,5
            ...
            <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-50" >
                <a href="https://sites.google.com/corp/google.com/pblv2/home" target="_blank" className='dark:text-zinc-50 text-zinc-900'>{import.meta.env.VITE_COMPANY_NAME}</a>
            </h1>
            </div>
            <div className="flex items-center space-x-4" >
